class TwitterController < ApplicationController
	...
	def generate_twitter_oauth_url
		...
		@consumer = OAuth::Consumer.new("HA3JNNBNQCqad6UtJBhzOCPL4","ZGOLbDOYzikG998S8O9C9vLt6JnFUHS3QxF8tBOqAHxJ42mtTl", :site => "https://api.twitter.com")
  ...
  def twitter_profile
	...
	def get_client
		Twitter.configure do |config|
		  config.consumer_key = "HA3JNNBNQCqad6UtJBhzOCPL4"
		  config.consumer_secret = "ZGOLbDOYzikG998S8O9C9vLt6JnFUHS3QxF8tBOqAHxJ42mtTl"
		end
